...
Leave::Leave(const char *name, int kind) : ::omnetpp::cMessage(name,kind)
{
}

Leave::Leave(const Leave& other) : ::omnetpp::cMessage(other)
{
    copy(other);
}
...
LeaveDescriptor::LeaveDescriptor() : omnetpp::cClassDescriptor("Leave", "omnetpp::cMessage")
{
